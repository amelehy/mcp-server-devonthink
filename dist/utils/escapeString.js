 ...
 */
export function escapeStringForJXA(input) {
 ...
 */
export function formatValueForJXA(value) {
 ...
 */
export function createJXAStringLiteral(value) {
    return `"${escapeStringForJXA(value)}"`;
}
/**
 ...
 */
export function isJXASafeString(input) {
