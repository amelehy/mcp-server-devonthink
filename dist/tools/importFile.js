...
const ImportFileSchema = z
    ...
    parentGroupUuid: z
        .string()
        .optional()
        .describe("UUID of the destination group (optional, overrides the default Inbox destination)"),
    databaseName: z
        .string()
        .optional()
        .describe("Database to import into when parentGroupUuid is not provided (optional, defaults to global Inbox when omitted)"),
})
    .strict();
