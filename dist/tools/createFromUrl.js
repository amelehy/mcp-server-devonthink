...
const CreateFromUrlSchema = z
    ...
    .strict();
const createFromUrl = async (input) => {
    const { url, format, name, parentGroupUuid, readability, userAgent, referrer, pdfOptions, databaseName, } = input;
    const script = `
    (() => {
...
export const createFromUrlTool = {
    ...
    inputSchema: zodToJsonSchema(CreateFromUrlSchema),
    run: createFromUrl,
};
