...
const SetRecordPropertiesSchema = z
    ...
    .strict()
    .refine((data) => data.uuid !== undefined || data.recordId !== undefined || data.recordPath !== undefined, { message: "Either uuid, recordId, or recordPath must be provided" });
const setRecordProperties = async (input) => {
    const { uuid, recordId, recordPath, databaseName, comment, flag, locked, excludeFromChat, excludeFromClassification, excludeFromSearch, excludeFromSeeAlso, excludeFromTagging, excludeFromWikiLinking, } = input;
...
export const setRecordPropertiesTool = {
    ...
    description: 'Set properties on a DEVONthink record (comment, flag, locked, exclude* flags).\n\nExample:\n{\n  "uuid": "1234-5678-90AB-CDEF",\n  "comment": "Updated by tool",\n  "flag": true,\n  "locked": true,\n  "excludeFromChat": true\n}',
    inputSchema: zodToJsonSchema(SetRecordPropertiesSchema),
